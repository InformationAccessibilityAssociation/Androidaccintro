...
METADATA['en'].about = [
      ...
      }, 
      {
        ...
        "url":"work/app-restrictions.html",
        "image":"images/work/cards/briefcase_600px.png",
        "category":"work",
        "type":"about",
        "keywords": [],
...
METADATA['en'].develop = [
      ...
      }, 
      {
        ...
        "summary":"Writing and running tests are important parts of the Android app development cycle. Well-written tests can help you catch bugs early in development and give you confidence in your code. Using Android Studio, you can run local unit tests or instrumented\u2026",
      ...
      }, 
      {
        ...
        "url":"training/performance/battery/network/gather-data.html",
      ...
      }, 
      {
        ...
        "url":"training/performance/battery/network/action-user-traffic.html",
        "category":"training",
        "type":"develop",
        "keywords": [],
        "tags": [],
      ...
      }, 
      {
        ...
        "url":"training/performance/battery/network/index.html",
        "category":"training",
        "type":"develop",
        "keywords": ["battery"],
        "tags": ["battery"],
      ...
      }, 
      {
        ...
        "url":"training/performance/battery/network/action-server-traffic.html",
        "category":"training",
        "type":"develop",
        "keywords": [],
        "tags": [],
      ...
      }, 
      {
        ...
        "url":"training/performance/battery/network/action-app-traffic.html",
        "category":"training",
        "type":"develop",
        "keywords": [],
        "tags": [],
      ...
      }, 
      {
        ...
        "url":"training/performance/battery/network/action-any-traffic.html",
        "category":"training",
        "type":"develop",
        "keywords": [],
        "tags": [],
      ...
      }, 
      {
        ...
        "url":"training/performance/battery/network/analyze-data.html",
...
METADATA['en'].distribute = [
      ...
      }, 
      {
        ...
        "type":"distribute",
        "keywords": [],
        "tags": ["googleplay","games","global","developerstory"],
      ...
      }, 
      {
        ...
        "summary":"The updated guide that helps you find success with your app or game business on Google Play.",
        "url":"distribute/googleplay/guide.html",
        "image":"distribute/images/play_dev_guide.png",
        "category":"googleplay",
        "type":"distribute",
        "keywords": ["play","protips"],
        "tags": ["secrets","success","play","google"],
...
METADATA['en'].ndk = [
      ...
      {
        "title":"NDK Downloads",
        "summary":"I have read and agree with the above terms and conditions Select, from the table above, the NDK package for your development platform. For information about the changes in the newest version of the NDK, see Release Notes . For information about earlier\u2026",
      ...
      }, 
      {
        ...
        "summary":"This page provides information on previous releases of the NDK, enumerating the changes that took place in each new version. Android NDK, Revision 11b (March 2016) Android NDK, Revision 11 (March 2016) Android NDK, Revision 10e (May 2015) Android NDK,\u2026",
        "url":"ndk/downloads/revision_history.html",
        "image":"assets/images/styles/disclosure_down.png",
        "category":"downloads",
        "type":"ndk",
        "keywords": [],
        "tags": [],
      ...
      {
        "title":"Concepts",
        "summary":"This guide assumes that you are already familiar with concepts inherent in native programming and in Android development . This section provides a high-level explanation of how the NDK works. The Android NDK is a set of tools allowing you to embed C or\u2026",
      ...
      {
        "title":"Vulkan Setup",
        "summary":"This document explains how to get started with the Vulkan graphics library by downloading, compiling, and running several sample apps. Before beginning, make sure you have the right hardware and platform version prepared. You should be using one of the\u2026",
        "url":"ndk/guides/graphics/getting-started.html",
      ...
      {
        "title":"Vulkan Validation Layers on Android",
        "summary":"Most explicit graphics APIs do not perform error-checking, because doing so can result in a performance penalty. Vulkan provides error-checking in a manner that lets you use this feature at development time, but exclude it from the release build of your\u2026",
        "url":"ndk/guides/graphics/validation-layer.html",
        "category":"guide",
        "type":"ndk",
        "keywords": [],
        "tags": [],
      ...
      {
        "title":"Vulkan Shader Compilers on Android",
        "summary":"A Vulkan app must manage shaders differently from the way an OpenGL ES app does so: In OpenGL ES, you provide a shader as a set of strings forming the source text of a GLSL shader program. By contrast, the Vulkan API requires you to provide a shader in\u2026",
        "url":"ndk/guides/graphics/shader-compilers.html",
        "category":"guide",
        "type":"ndk",
        "keywords": [],
        "tags": [],
      ...
      {
        "title":"Vulkan Design Guidelines",
        "summary":"Vulkan is unlike earlier graphics APIs in that drivers do not perform certain optimizations, such as pipeline reuse, for apps. Instead, apps using Vulkan must implement such optimizations themselves. If they do not, they may exhibit worse performance \u2026",
        "url":"ndk/guides/graphics/design-notes.html",
        "category":"guide",
        "type":"ndk",
        "keywords": [],
        "tags": [],
      ...
      }, 
      {
        ...
        "summary":"The Android platform includes an Android-specific implementation of the Vulkan API specification from the Khronos Group. Vulkan is a low-overhead, cross-platform API for high-performance, 3D graphics. It provides tools for creating high-quality, real-time\u2026",
        "url":"ndk/guides/graphics/index.html",
        "category":"guide",
        "type":"ndk",
        "keywords": [],
        "tags": [],
      ...
      {
        "title":"High-Performance Audio Basics",
        "summary":"Google I&#47;O 2013 - High Performance Audio The Khronos Group&#39;s OpenSL ES\u2122 standard exposes audio features similar to those in the MediaPlayer and MediaRecorder APIs in the Android Java framework. OpenSL ES provides a C language interface as well\u2026",
        "url":"ndk/guides/audio/basics.html",
        "category":"guide",
        "type":"ndk",
        "keywords": [],
        "tags": [],
      ...
      }, 
      {
        ...
        "summary":"This page provides details about how the NDK implementation of OpenSL ES\u2122 differs from the reference specification for OpenSL ES 1.0.1. When using sample code from the specification, you may need to modify it to work on Android. Unless otherwise noted\u2026",
        "url":"ndk/guides/audio/opensl-for-android.html",
        "category":"guide",
        "type":"ndk",
        "keywords": [],
        "tags": [],
      ...
      }, 
      {
        ...
        "summary":"The notes in this section supplement the OpenSL ES 1.0.1 specification . Two aspects of the OpenSL ES programming model that may be unfamiliar to new developers are the distinction between objects and interfaces, and the initialization sequence. Briefly\u2026",
        "url":"ndk/guides/audio/opensl-prog-notes.html",
        "category":"guide",
        "type":"ndk",
        "keywords": [],
        "tags": [],
      ...
      {
        "title":"NDK High-Performance Audio",
        "summary":"The NDK package includes an Android-specific implementation of the OpenSL ES\u2122 API specification from the Khronos Group . This library allows you to use C or C++ to implement high-performance, low-latency audio, whether you are writing a synthesizer, digital\u2026",
        "url":"ndk/guides/audio/index.html",
        "category":"guide",
        "type":"ndk",
        "keywords": [],
        "tags": [],
      ...
      }, 
      {
        ...
        "summary":"This page provides guidelines to help you reduce audio input latency when recording with a built-in microphone or an external headset microphone. Here are a few important prerequisites: The following are some methods to help ensure low audio input latency\u2026",
        "url":"ndk/guides/audio/input-latency.html",
        "category":"guide",
        "type":"ndk",
        "keywords": [],
        "tags": [],
      ...
      }, 
      {
        ...
        "summary":"Will it Float? The Glory and Shame of Floating-Point Audio Using floating-point numbers to represent audio data can significantly enhance audio quality in high-performance audio applications. Floating point offers the following advantages: While floating-point\u2026",
        "url":"ndk/guides/audio/floating-point.html",
        "category":"guide",
        "type":"ndk",
        "keywords": [],
        "tags": [],
      ...
      }, 
      {
        ...
        "summary":"Audio latency: buffer sizes Building great multi-media experiences on Android This page describes how to develop your audio app for low-latency output and how to avoid warmup latency. Low-latency audio is currently only supported when using Android&#39\u2026",
        "url":"ndk/guides/audio/output-latency.html",
        "category":"guide",
        "type":"ndk",
        "keywords": [],
        "tags": [],
      ...
      {
        "title":"Sample Rates",
        "summary":"Sample Rates: Why Can&#39;t We All Just Agree? As of Android 5.0 (Lollipop), the audio resamplers are now entirely based on FIR filters derived from a Kaiser windowed-sinc function. The Kaiser windowed-sinc offers the following properties: The design \u2026",
        "url":"ndk/guides/audio/sample-rates.html",
        "category":"guide",
        "type":"ndk",
        "keywords": [],
        "tags": [],
      ...
      {
        "title":"ndk-build",
        "summary":"The make command that runs the NDK build scripts. Combine ndk-build and options in the form ndk-build &lt;option&gt; . For example: The following options are available: Use the NDK_DEBUG option and, in certain cases, xml to specify debug or release build\u2026",
      ...
      }, 
      {
        ...
        "summary":"You can use the toolchains provided with the Android NDK independently, or as plug-ins with an existing IDE. This flexibility can be useful if you already have your own build system, and only need the ability to invoke the cross-compiler in order to add\u2026",
